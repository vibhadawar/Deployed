...
function darkModeProperties() {
  ...
  root.setProperty("--lm-icon-bg", "brightness(200%)");
  darkMode = true;
  console.log("darkmode changed to " + darkMode);
  localStorage.setItem("dark-mode", "true"); // Correctly set to "true"
}
...
function lightModeProperties() {
  ...
  darkMode = false;
  console.log("darkmode changed to " + darkMode);
  localStorage.setItem("dark-mode", "false"); // Correctly set to "false"
}
